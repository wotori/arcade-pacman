...
class $013e68578e569550$var$Ghost {
...
class $013e68578e569550$var$Pacman {
...
class $013e68578e569550$export$fb4646ab13eb7425 {
    constructor(){
   ...
   */ reset() {
        ...
        if (this.firstGame) {
            ...
            this.pacman = new $013e68578e569550$var$Pacman(this.scaledTileSize, this.mazeArray, new $013e68578e569550$var$CharacterUtil());
            this.blinky = new $013e68578e569550$var$Ghost(this.scaledTileSize, this.mazeArray, this.pacman, "blinky", this.level, new $013e68578e569550$var$CharacterUtil());
            this.pinky = new $013e68578e569550$var$Ghost(this.scaledTileSize, this.mazeArray, this.pacman, "pinky", this.level, new $013e68578e569550$var$CharacterUtil());
            this.inky = new $013e68578e569550$var$Ghost(this.scaledTileSize, this.mazeArray, this.pacman, "inky", this.level, new $013e68578e569550$var$CharacterUtil(), this.blinky);
            this.clyde = new $013e68578e569550$var$Ghost(this.scaledTileSize, this.mazeArray, this.pacman, "clyde", this.level, new $013e68578e569550$var$CharacterUtil());
            this.fruit = new $013e68578e569550$var$Pickup("fruit", this.scaledTileSize, 13.5, 17, this.pacman, this.mazeDiv, 100);
        }
        this.entityList = [
            this.pacman,
            this.blinky,
        ...
        if (this.firstGame) {
            ...
            this.soundManager = new $013e68578e569550$var$SoundManager();
   ...
   */ init() {
        ...
        this.gameEngine = new $013e68578e569550$var$GameEngine(this.maxFps, this.entityList);
        ...
        mazeArray.forEach((row, rowIndex)=>{
            row.forEach((block, columnIndex)=>{
                if (block === "o" || block === "O") {
                    ...
                    const dot = new $013e68578e569550$var$Pickup(type, this.scaledTileSize, columnIndex, rowIndex, this.pacman, this.dotContainer, points);
                    entityList.push(dot);
   ...
   */ startGameplay(initialStart) {
        ...
        new $013e68578e569550$var$Timer(()=>{
   ...
   */ ghostCycle(mode) {
        ...
        this.ghostCycleTimer = new $013e68578e569550$var$Timer(()=>{
            this.ghosts.forEach((ghost)=>{
   ...
   */ releaseGhost() {
        if (this.idleGhosts.length > 0) {
            ...
            this.endIdleTimer = new $013e68578e569550$var$Timer(()=>{
   ...
   */ createFruit() {
        ...
        this.fruitTimer = new $013e68578e569550$var$Timer(()=>{
            this.fruit.hideFruit();
        }, 10000);
    }
    /**
                                ...
                                new $013e68578e569550$var$Timer(()=>{
                                    ...
                                    new $013e68578e569550$var$Timer(()=>{
                                        ...
                                        this.entityList.forEach((entity)=>{
                                            ...
                                            entityRef.reset();
                                            if (entityRef instanceof $013e68578e569550$var$Ghost) entityRef.resetDefaultSpeed();
                                            if (entityRef instanceof $013e68578e569550$var$Pickup && entityRef.type !== "fruit") this.remainingDots += 1;
                                        });
                                        this.startGameplay();
                                    }, 500);
                                }, 250);
   ...
   */ flashGhosts(flashes, maxFlashes) {
        if (flashes === maxFlashes) {
            ...
            this.ghostFlashTimer = new $013e68578e569550$var$Timer(()=>{
...
class $013e68578e569550$var$GameEngine {
...
class $013e68578e569550$var$Pickup {
...
class $013e68578e569550$var$CharacterUtil {
    constructor(){
        this.directions = {
            up: "up",
            down: "down",
...
class $013e68578e569550$var$SoundManager {
    constructor(){
...
class $013e68578e569550$var$Timer {
...
function $9ebea141caae719f$export$2b296bc7b2c2a18d() {
    console.log("init coordinator");
    let gameCoordinator = new (0, $013e68578e569550$export$fb4646ab13eb7425)();
    console.log("gameCoordinator is laoded", gameCoordinator);
}
async function $9ebea141caae719f$var$loadScoreboard() {
...
window.onload = ()=>{
    $9ebea141caae719f$export$2b296bc7b2c2a18d();
    $9ebea141caae719f$var$loadScoreboard();
};
