...
class $672334471c310949$var$Ghost {
...
class $672334471c310949$var$Pacman {
...
class $672334471c310949$export$fb4646ab13eb7425 {
    constructor(){
   ...
   */ reset() {
        ...
        if (this.firstGame) {
            ...
            this.pacman = new $672334471c310949$var$Pacman(this.scaledTileSize, this.mazeArray, new $672334471c310949$var$CharacterUtil());
            this.blinky = new $672334471c310949$var$Ghost(this.scaledTileSize, this.mazeArray, this.pacman, "blinky", this.level, new $672334471c310949$var$CharacterUtil());
            this.pinky = new $672334471c310949$var$Ghost(this.scaledTileSize, this.mazeArray, this.pacman, "pinky", this.level, new $672334471c310949$var$CharacterUtil());
            this.inky = new $672334471c310949$var$Ghost(this.scaledTileSize, this.mazeArray, this.pacman, "inky", this.level, new $672334471c310949$var$CharacterUtil(), this.blinky);
            this.clyde = new $672334471c310949$var$Ghost(this.scaledTileSize, this.mazeArray, this.pacman, "clyde", this.level, new $672334471c310949$var$CharacterUtil());
            this.fruit = new $672334471c310949$var$Pickup("fruit", this.scaledTileSize, 13.5, 17, this.pacman, this.mazeDiv, 100);
        }
        this.entityList = [
            this.pacman,
            this.blinky,
        ...
        if (this.firstGame) {
            ...
            this.soundManager = new $672334471c310949$var$SoundManager();
   ...
   */ init() {
        ...
        this.gameEngine = new $672334471c310949$var$GameEngine(this.maxFps, this.entityList);
        ...
        mazeArray.forEach((row, rowIndex)=>{
            row.forEach((block, columnIndex)=>{
                if (block === "o" || block === "O") {
                    ...
                    const dot = new $672334471c310949$var$Pickup(type, this.scaledTileSize, columnIndex, rowIndex, this.pacman, this.dotContainer, points);
                    entityList.push(dot);
   ...
   */ startGameplay(initialStart) {
        ...
        new $672334471c310949$var$Timer(()=>{
   ...
   */ ghostCycle(mode) {
        ...
        this.ghostCycleTimer = new $672334471c310949$var$Timer(()=>{
            this.ghosts.forEach((ghost)=>{
   ...
   */ releaseGhost() {
        if (this.idleGhosts.length > 0) {
            ...
            this.endIdleTimer = new $672334471c310949$var$Timer(()=>{
   ...
   */ createFruit() {
        ...
        this.fruitTimer = new $672334471c310949$var$Timer(()=>{
            this.fruit.hideFruit();
        }, 10000);
    }
    /**
                                ...
                                new $672334471c310949$var$Timer(()=>{
                                    ...
                                    new $672334471c310949$var$Timer(()=>{
                                        ...
                                        this.entityList.forEach((entity)=>{
                                            ...
                                            entityRef.reset();
                                            if (entityRef instanceof $672334471c310949$var$Ghost) entityRef.resetDefaultSpeed();
                                            if (entityRef instanceof $672334471c310949$var$Pickup && entityRef.type !== "fruit") this.remainingDots += 1;
                                        });
                                        this.startGameplay();
                                    }, 500);
                                }, 250);
   ...
   */ flashGhosts(flashes, maxFlashes) {
        if (flashes === maxFlashes) {
            ...
            this.ghostFlashTimer = new $672334471c310949$var$Timer(()=>{
...
class $672334471c310949$var$GameEngine {
...
class $672334471c310949$var$Pickup {
...
class $672334471c310949$var$CharacterUtil {
    constructor(){
        this.directions = {
            up: "up",
            down: "down",
...
class $672334471c310949$var$SoundManager {
    constructor(){
...
class $672334471c310949$var$Timer {
...
function $c13b0713987413e7$export$2b296bc7b2c2a18d() {
    console.log("init coordinator");
    let gameCoordinator = new (0, $672334471c310949$export$fb4646ab13eb7425)();
    console.log("gameCoordinator is laoded", gameCoordinator);
}
async function $c13b0713987413e7$var$loadScoreboard() {
...
window.onload = ()=>{
    $c13b0713987413e7$export$2b296bc7b2c2a18d();
    $c13b0713987413e7$var$loadScoreboard();
};
